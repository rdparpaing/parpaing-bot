...
module.exports = async (op, message, supabase) => {
  ...
  scd = scd.sort((a, b) => (b.rating - a.rating) * op).slice(0, scd.length >= 5 ? 5 : scd.length)
  let embed = new MessageEmbed()
      .setTitle(op < 0 ? "**SRS**: Pire citoyens" : "**SRS**: Meilleurs citoyens")
      .setColor("GREEN")
      .setAuthor("Social RdP System", "https://i.imgur.com/dSl4OCN.png")
      .setDescription(op < 0 ? "Voici les 5 pire citoyens du régime" : "Voici les 5 meilleurs citoyens du régime")
